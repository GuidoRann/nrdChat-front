      ...
      {isOpen && (
        <div className="animate-fade-in animate-duration-300 fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <section className="bg-white h-[250px] w-[50%] flex flex-col items-center rounded-2xl">
            <div className="w-full h-full flex flex-col items-center text-gray-500 font-poppins text-xl font-bold overflow-y-auto">
              ...
              <div className="py-3 h-full flex flex-col justify-center">
              {storePendingFriends.length > 0 ?
              ...
              : <h1>No tienes amigos pendientes</h1>}
              </div>
